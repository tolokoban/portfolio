...
<Flex>
    <Image name="akonolinga/app-1" alt="Akonolinga" size={[844, 725]}>
        History of all events relating to a patient
    </Image>
    <Image name="akonolinga/app-2" alt="Akonolinga" size={[654, 766]}>
        The structure of the fields is dynamic and are edited remotely by
        doctors
    </Image>
    <Image name="akonolinga/app-3" alt="Akonolinga" size={[800, 422]}>
