...
<Flex>
    <Image name="akonolinga/app-1" alt="Akonolinga" size={[640, 550]}>
        History of all events relating to a patient
    </Image>
    <Image name="akonolinga/app-2" alt="Akonolinga" size={[640, 750]}>
        The structure of the fields is dynamic and are edited remotely by
        doctors
    </Image>
    <Image name="akonolinga/app-3" alt="Akonolinga" size={[640, 338]}>
...
<Flex>
    <Image name="akonolinga/web-soins-1" alt="Akonolinga" size={[640, 444]}>
    ...
    <Image
        name="akonolinga/web-soins-2"
        alt="Akonolinga"
        size={[640, 370]}
    ></Image>
    <Image
        name="akonolinga/web-soins-3"
        alt="Akonolinga"
        size={[640, 384]}
    ></Image>
</Flex>
