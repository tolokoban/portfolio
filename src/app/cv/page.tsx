...
export default function PageCV() {
    ...
    return (
        <div>
            ...
            <h2>Skills</h2>
            <p>
                <b>Human languages</b>: French (father tongue), Italian (mother
                tongue), English (5 years in an english environment)
            </p>
            <p>
                <b>Computer languages</b>: HTML5, CSS3, Javascript, Typescript,
                SVG, WebGL, MathML, PHP, Python3, Rust, C#, C++, JAVA, LaTeX
            </p>
            <p>
                <b>Tools</b>: React, Webpack, Jest, ESLint, Prettier, Blender,
                Krita, Visual Studio Code, Electron, NodeJS, npm, git, ThreeJS
            </p>
            <h2>Hobbies</h2>
            <p>
                <b>Sport</b>: Trail-running (GR5 2024, Diagonale des fous 2015,
                UTMB 2005, …), Basket-Ball, free-falling (72 jumps)
            </p>
            <p>
                <b>Media</b>: 3D modeling, VFX and video editing with Blender,
                digital painting with Krita, short film maker (Le Morbide)
            </p>
            <p>
                <b>Readings</b>: Metal Hurlant, Martin Gardener, Sam Loyd,
                Raymon Smullyan, Donald Knuth, Russel/Norvig, Liu Xin (three
                body problem), Lovecraft, ...
            </p>
        </div>
    )
}
