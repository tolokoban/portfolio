...
<Flex>
    <Image name="work/minervois/welcome" alt="Welcome" size={[640, 480]}/>

    <Image name="work/minervois/tree" alt="Easy organization" size={[640, 480]}>
        Easily organize groups and maps with drag & drop.
    </Image>

    <Image name="work/minervois/theme" alt="Theme and logo" size={[640, 480]}>
        Define your application theme and logo.
    </Image>

    <Image name="work/minervois/maps" alt="Maps" size={[640, 480]}>
        Add as many maps as you want.
    </Image>

    <Image name="work/minervois/deployment" alt="Deployment" size={[640, 236]}>
        Deploy a Test and/or a Prod version of your content.
    </Image>

    <Image name="work/minervois/preview" alt="Preview" size={[640, 480]}>
        Preview your application with a GPS simulator.
    </Image>

    <Image name="work/minervois/stats" alt="Stats and Ratings" size={[640, 601]}>
