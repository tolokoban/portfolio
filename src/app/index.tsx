...
const Page41 = React.lazy(() => import("./work/articles/VoughtTower/page.mdx"))
const Page42 = React.lazy(() => import("./work/articles/Webgl/page.mdx"))
const Page43 = React.lazy(() => import("./work/articles/Wedding/page.mdx"))
const Page43_1 = React.lazy(() => import("./work/articles/Wedding/page.en.mdx"))
        ...
        <Route path="/" Page={pg0} Layout={ly0} fallback={fb0} context={context}>
            ...
            <Route path="/work" Page={pg11} Layout={ly11} fallback={fb0} context={context}>
                <Route path="/work/articles" Layout={ly12} fallback={fb0} context={context}>
                    ...
                    <Route path="/work/articles/VoughtTower" Page={pg41} fallback={fb0} context={context}/>
                    <Route path="/work/articles/Webgl" Page={pg42} fallback={fb0} context={context}/>
                    <Route path="/work/articles/Wedding" Page={pg43} fallback={fb0} context={context}/>
                </Route>
            </Route>
        </Route>
    )
